...
public class ResourceSqlFactoryTest {
    ...
    @SqlFromResource("ninja/javahacker/test/lorem-utf-8")
    private static void withSql1() {
        throw new AssertionError();
    }

    @SqlFromResource(value = "ninja/javahacker/test/lorem-utf-8", encoding = CharsetSpec.Utf8.class)
    private static void withSql2() {
        throw new AssertionError();
    }

    @SqlFromResource(value = "ninja/javahacker/test/lorem-iso-8859-1", encoding = CharsetSpec.Iso88591.class)
    private static void withSql3() {
        throw new AssertionError();
    }

    @SqlFromResource("ninja/javahacker/test/does-not-exist")
    private static void withSqlX1() {
        throw new AssertionError();
    }

    @SqlFromResource(value = "ninja/javahacker/test/lorem-utf-8", encoding = CharsetSpec.Iso88591.class)
    ...
    @Test
    public void testSupplierSqlDoesNotExist() throws Exception {
    ...
    @Test
    public void testSupplierSqlBadEncoding() throws Exception {
