...
public enum ReadPolicy {
    ...
    ///
    /// Any [IOException] encountered during reading causes a
    ...
    ///
    /// If the read attempt fails, the error is propagated as a [SQLException] and
    ...
    /// calls (from any thread) will keep throwing the same [SQLException] without
    /// ever retrying.
    ...
    /// each call. Any [IOException] is wrapped in a [SQLException].
