...
import ninja.javahacker.annotimpler.jpa.config.OptionalBoolean;
import ninja.javahacker.annotimpler.jpa.config.ProviderConnectorFactory;
import ninja.javahacker.annotimpler.jpa.config.SchemaGenerationAction;
import ninja.javahacker.annotimpler.jpa.config.SchemaGenerationActionTarget;
import ninja.javahacker.annotimpler.jpa.config.SchemaGenerationSource;
