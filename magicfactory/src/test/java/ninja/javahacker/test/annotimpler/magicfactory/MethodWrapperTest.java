...
public class MethodWrapperTest {
    ...
    public Stream<DynamicTest> testInstanceMethodWrapper() throws Exception {
        ...
        return Stream.of(
            ...
            n("ab1", () -> Assertions.assertThrows(IllegalArgumentException.class, () -> w.call(SMT, 777, 888.0, Thread.currentThread()))),
            n("ac1", () -> Assertions.assertThrows(IllegalArgumentException.class, () -> w.call(SMT, null, 888.0, "xxx"))),
            n("s2", () -> Assertions.assertThrows(IllegalArgumentException.class, () -> w.paramMap())),
            n("t2", () -> Assertions.assertThrows(IllegalArgumentException.class, () -> w.paramMap("x"))),
            ...
            n("ab2", () -> Assertions.assertThrows(IllegalArgumentException.class, () -> w.paramMap(SMT, 777, 888.0, Thread.currentThread()))),
            n("ac2", () -> Assertions.assertThrows(IllegalArgumentException.class, () -> w.paramMap(SMT, null, 888.0, "xxx"))),
            n("ad", () -> ForTests.testNull("params", () -> w.call((Object[]) null))),
            n("ae", () -> Assertions.assertEquals("method String Something.bar(int, double, String)", w.toString())),
            n("af", () -> Assertions.assertEquals("Method String Something.bar(int, double, String)", w.toStringUp())),
            n("hc1", () -> Assertions.assertEquals(w2.hashCode(), w.hashCode())),
            n("eq1", () -> Assertions.assertEquals(w2, w)),
            n("hc2", () -> Assertions.assertNotEquals(w3.hashCode(), w.hashCode())),
            n("eq2", () -> Assertions.assertNotEquals(w3, w)),
