/// Provides JDBC [ninja.javahacker.annotimpler.jdbc.ConnectionFactory] implementations for
/// commonly used relational database systems, together with JSON serialisation support via
/// [ninja.javahacker.annotimpler.jdbc.conn.JsonConnector].
///
/// All concrete connectors are immutable records (or a singleton enum in the case of
/// [ninja.javahacker.annotimpler.jdbc.conn.SqliteMemoryConnector]).
...
/// [ninja.javahacker.annotimpler.jdbc.conn.JsonConnector#read(String)].
